...
export const MODULE_FLOWS: Record<string, FlowStep[]> = {
  ...
  consultations: [
    ...
    { title: "Result: record consultations", description: "Diagnosis, advice, outcome & plan.", kpiLabel: "All consultations", href: "/consultations", actionLabel: "Consultations", icon: "stethoscope" },
  ],
  referrals: [
    { title: "Start: log a referral", description: "Patient / doctor / org referral.", href: "/referrals", actionLabel: "Referrals", icon: "referral" },
    { title: "Result: conversion", description: "Track conversion & top referrers.", kpiLabel: "All referrals", href: "/referrals", actionLabel: "View", icon: "chart" },
  ],
  camps: [
    ...
    { title: "Result: ROI", description: "Budget vs spend, ROI & IP admissions.", href: "/outreach/reports", actionLabel: "Outreach reports", icon: "chart" },
  ],
  "mobile-clinics": [
    ...
    { title: "Result: ROI", description: "Budget vs spend & branch referrals.", href: "/outreach/reports", actionLabel: "Outreach reports", icon: "chart" },
  ],
  "follow-ups": [
    { title: "Start: due today", description: "Today's follow-up tasks.", kpiLabel: "Due today", href: "/follow-ups", actionLabel: "Follow-ups", icon: "bell" },
    { title: "Clear overdue", description: "Ageing & escalation.", kpiLabel: "Overdue", href: "/follow-ups", actionLabel: "Overdue", icon: "hourglass" },
    { title: "Result: pending closed", description: "Pending & booked follow-ups.", kpiLabel: "Pending", href: "/follow-ups", actionLabel: "View", icon: "chart" },
  ],
  admissions: [
  ...
  retention: [
    { title: "Start: at-risk patients", description: "Risk categories & reactivation tasks.", kpiLabel: "At risk", href: "/retention", actionLabel: "Retention", icon: "heart" },
    { title: "Work the queue", description: "High-risk reactivation work queue.", href: "/prioritize", actionLabel: "Prioritize", icon: "target" },
    { title: "Result: recover lost", description: "Lapsed patients to win back.", kpiLabel: "Lost", href: "/retention", actionLabel: "View", icon: "chart" },
  ],
  campaigns: [
